...
pub async fn handle(mp: &MultiProgress, opt_version: Option<String>, opt_loader_version: Option<String>, limit: String, username: String, javaagent: bool) {
    ...
    vanilla::handle(mp, Some(version), limit.clone(), false, Some(ver_path.as_path()), username, javaagent).await;
}
